...
pdf("C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/BeforeNorm_Neurons.pdf")
...
pdf("C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/nDEGs_HKgenes_p0.4_Neurons.pdf")
...
write.csv(pcavaluesfinal, file="C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/pca_correlation_values_nDEGs_HKgenes_Neurons.csv")
...
write.table (N, file="C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/DATA/countData_RUV_Normalized_Neurons_nDEGs_HKgenes_p0.4_k4.txt")
...
pdf(file="C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/WGCNA_SoftThreshold_Neuron_nDEGs_HKgenes_p0.4_k4.pdf")
dev.off()
...
####dendogram modules
sizeGrWindow(12, 9)
pdf("C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/Cluster_dendogram_neurons.pdf")
...
#Sup Table 10
write.csv(kmeTable, "C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/kME_Neuron_nDEGs_HKgenes_p0.4_k4.csv", row.names=FALSE)
...
write.csv(me, "C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/ME_Neuron_nDEGs_HKgenes_p0.4_k4.csv", row.names=FALSE)

#Plotting Module Eigengene Values
colors=rep("turquoise", nrow(me) )
colors[grep("_P_", me$Sample)]="red"

pdf("C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/moduleBarplots_Neuron_nDEGs_HKgenes_p0.4_k4.pdf", height=5, width=15)
...
sizeGrWindow(10,6)
pdf("C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/RESULTS/Neurons/Module-TRait_relationship_Neuron_nDEGs_HKgenes_p0.4_k4.pdf")
...
write.csv(allStudies, file="modules_allStudies_final.csv", row.names = FALSE)
...
userListEnrichment(
  geneR, labelR, 
  fnIn = ("C:/Users/karin/Dropbox/Arquivos_genomica_autistas/RNAseq/RNAseq_files/Resultados_finais/enrichment_analysis/modules_allStudies_final.csv"),
  nameOut = "module_overlap_neurons_allStudies_final.csv",
  omitCategories = c("M0","grey"), outputGenes = TRUE) 


#calculating odds ratio
#to calculate all the fields for the fisher table
#otherstudy2=left_join(derosa35,allgenes, by="Gene")
ss=subset(otherstudy2, otherstudy2$Module.x=="lightyellow_Schafer" & otherstudy2$Module.y=="M1")
sn=subset(otherstudy2, otherstudy2$Module.x=="lightyellow_Schafer" & !otherstudy2$Module.y=="M1")
ns=subset(otherstudy2, !otherstudy2$Module.x=="lightyellow_Schafer" & otherstudy2$Module.y=="M1")
nn=subset(otherstudy2, !otherstudy2$Module.x=="lightyellow_Schafer" & !otherstudy2$Module.y=="M1")

#create a file "tablefisher_module_overlap_neurons.txt"

enrichmenttab=read.csv("module_overlap_neurons_allStudies_final.csv")
tabfisher=read.delim("tablefisher_module_overlap_neurons.txt")
enrichmenttab1=subset(enrichmenttab, enrichmenttab$InputCategories=="M1")
enrichmenttab2=subset(enrichmenttab, enrichmenttab$InputCategories=="M18")
enrichmenttab=rbind(enrichmenttab1,enrichmenttab2)
...
enrichmenttab=enrichmenttab[,c(1:4,13,5:12)]
write.csv(enrichmenttab, file="module_overlap_neurons_allStudies_m1_m18_final.csv")
